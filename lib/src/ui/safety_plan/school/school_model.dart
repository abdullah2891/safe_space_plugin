...
class SchoolModel extends FlutterFlowModel {
  ...
  void saveOnline() async {
    DatabaseProxy('safetyPlanDb').put('school', {
  ...
  static Future<SchoolModel> getOnline() async {
    final snapshot = await DatabaseProxy('safetyPlanDb').get('school');
    SchoolModel b = SchoolModel();
    ...
    if (snapshot != null) {
      ...
      if (map['radioButtonValue'] != null) {
        b.radioButtonValue = map['radioButtonValue'] as String;
      }
    }
