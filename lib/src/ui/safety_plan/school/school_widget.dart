...
class _SchoolWidgetState extends State<SchoolWidget> {
  ...
  void initState() {
    ...
    SchoolModel.getOnline().then((value) => {
          setState(() {
            _model = value;
          })
        });
                        ...
                        child: Form(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'IF YOU NEED TO AVOID SEEING YOUR PARTNER ON YOUR WAY TO OR FROM CLASS, WHAT ROUTE CAN YOU TAKE TO GET YOU THERE SAFELY?',
                                ...
                                FlutterFlowRadioButton(
                                  ...
                                  initialValue: _model.radioButtonValue ?? 'hi',
                                  optionHeight: 25,
                                ...
                                Text(
                                  'WHOM CAN YOU SPEND TIME WITH BETWEEN CLASSES, SO THAT YOU ARE NOT ALONE?',
                                  style: FlutterFlowTheme.of(context).bodyText1,
                                ),
                                TextFormField(
                                ...
                                Text(
                                  'IF YOU NEED TO LEAVE SCHOOL IMMEDIATELY, WHOM CAN YOU CALL TO PICK YOU UP OR MEET YOU?',
                                  style: FlutterFlowTheme.of(context).bodyText1,
                                ),
                                TextFormField(
